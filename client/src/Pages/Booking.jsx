...
// Cars array (unchanged, you can add more objects here freely)
const cars = [
  {
    id: 1,
    name: "Tesla Model 3",
  ...
  return (
    selectedCar ? (
      <div className="container mx-auto p-6 pt-28 transition-colors duration-300">
        ...
        {/* EXISTING DETAIL SECTION — UNCHANGED */}
        ...
        {/* 🔽 NEW SECTION — MORE CARS (NO ROUTE CHANGE) */}
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {cars
              ...
              .map(car => (
                <div
                  key={car.id}
                  className="p-4 rounded-xl bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow hover:shadow-lg transition-all"
                >
                  <img
                    src={car.image}
                    alt={car.name}
