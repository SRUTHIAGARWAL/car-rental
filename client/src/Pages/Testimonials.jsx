...
// Helper component for review highlight
const HighlightCard = ({ title, count, color, bgColor, delay }) => (
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    whileInView={{ opacity: 1, y: 0 }}
    transition={{ delay }}
    className={`${bgColor} rounded-xl p-6 text-center border border-transparent dark:border-zinc-800/50`}
  >
    <div className="flex flex-col items-center">
      <h3 className={`text-2xl font-bold mb-2 ${color}`}>{count.toLocaleString()}+</h3>
      <p className="text-gray-700 dark:text-zinc-300 font-medium">{title}</p>
    </div>
  </motion.div>
);
...
const Testimonials = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-zinc-950 dark:to-zinc-900 pt-8 transition-colors duration-300">
      ...
      <section className="pt-16 pb-4">
        <div className="container mx-auto px-4">
          <motion.div variants={fadeIn} initial="initial" whileInView="whileInView" className="text-center max-w-3xl mx-auto">
            ...
            <motion.div whileHover={{ scale: 1.05 }} className="inline-flex items-center gap-2 px-4 py-2 bg-orange-100 dark:bg-orange-900/30 rounded-full mb-6 cursor-pointer hover:bg-orange-200 dark:hover:bg-orange-800 transition-colors duration-200">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="relative">
            <motion.div key={activeIndex} initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="bg-white dark:bg-zinc-900 rounded-2xl p-8 md:p-12 shadow-sm border border-transparent dark:border-zinc-800 transition-colors">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <motion.div variants={fadeIn} initial="initial" whileInView="whileInView" className="bg-orange-500 rounded-2xl p-8 md:p-12 text-center text-white shadow-xl shadow-orange-500/20">
